  ...
  return (
    <>
      <tr>
        ...
        <td>
          <Render
            formula={`\\(\\frac{-${val.f3} + 4*${val.f2} - 5*${val.f1} + 2*${val.f0}}{12*${val.h}}\\)`}
          />
        </td>
      </tr>
      <tr>
        ...
        <td>
          <Render
            formula={`\\(\\frac{-${val.f3} + ${4 * val.f2} - ${5 * val.f1} + ${
              2 * val.f0
            }}{${12 * val.h}}\\)`}
          />
        </td>
      ...
      <tr>
        ...
        <td>
          <Render
            formula={`\\(\\frac{${
              -val.f3 + 4 * val.f2 - 5 * val.f1 + 2 * val.f0
            }}{${12 * val.h}}\\)`}
          />
        </td>
      </tr>
      <tr>
        ...
        <td>
          <Render
            formula={turunanKeduaOrde2(val.f0, val.f1, val.f2, val.f3, val.h)}
          />
        </td>
      </tr>
    </>
